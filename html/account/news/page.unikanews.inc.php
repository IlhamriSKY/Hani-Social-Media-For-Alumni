<?php
        ...
        if ($items_loaded != 0) {
            ...
            if ($result['items_loaded'] < $items_all) {
                ...
                <header class="top-banner loading-banner">
                    <div class="prompt">
                        <button onclick="Items.more('/account/news/unikanews', '<?php echo $result['itemId']; ?>'); return false;" class="button more loading-button"><?php echo $LANG['action-more']; ?></button>
                    </div>
                </header>
                <?php
    ...
    $page_title = $LANG['page-unikanews']." | ".APP_TITLE;
                ...
                <div class="main-content">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><?php echo $LANG['page-unikanews']; ?></h3>
                            <h5 class="card-description"><?php echo $LANG['page-unikanews-description']; ?></h5>
                        </div>
                    </div>
