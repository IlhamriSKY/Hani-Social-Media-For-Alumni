<?php
        ...
        if ($items_loaded != 0) {
            ...
            if ($result['items_loaded'] < $items_all) {
                ...
                <header class="top-banner loading-banner">
                    <div class="prompt">
                        <button onclick="Items.more('/account/news/campushiring', '<?php echo $result['itemId']; ?>'); return false;" class="button more loading-button"><?php echo $LANG['action-more']; ?></button>
                    </div>
                </header>
                <?php
    ...
    $page_id = "campushiring";
    $css_files = array("main.css");
    $page_title = $LANG['page-campushiring']." | ".APP_TITLE;
                ...
                <div class="main-content">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><?php echo $LANG['page-campushiring']; ?></h3>
                            <h5 class="card-description"><?php echo $LANG['page-campushiring-description']; ?></h5>
                        </div>
                    </div>
                                ...
                                <div class="card">
                                    <li class="custom-list-item post-item">
                                        <div class="mb-2 item-header">
                                            <a href="/adminsscc" class="item-logo" style="background-image:url('/photo/thumb_big_4d25d2g.jpg')"></a>
                                            <span title="Online" class="item-logo-online"></span>
                                            <a href="/adminsscc" class="custom-item-link post-item-fullname">Admin SSCC</a>
                                            ...
                                            <span class="user-badge user-staff-badge ml-1" rel="tooltip" title="Staff account"><i class="iconfont icofont-businessman"></i></span>
