...
/*! Hani Halo Alumni v1  */
    ...
    if (!empty($_POST)) {
        ...
        $result = $buku_alumni->getMyItems($itemId);
        ...
        if ($items_loaded != 0) {
            ...
            if ($result['items_loaded'] < $items_all) {
                ...
                <header class="top-banner loading-banner">
                    ...
                    <div class="prompt">
                        <button onclick="Bukualumni.productsMore('<?php echo $result['itemId']; ?>'); return false;" class="button more loading-button"><?php echo $LANG['action-more']; ?></button>
                    </div>
    ...
    $page_title = $LANG['page-buku-alumni-ku']." | ".APP_TITLE;
            ...
            <div class="row col sn-content sn-content-wide-block" id="content">
                ...
                <div class="main-content">
                    ...
                    <div class="content-list-page">
                        ...
                        $result = $buku_alumni->getMyItems(0);
